    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-20">
          <Link href="/" className="text-lg font-medium tracking-wider text-white/90 hover:text-white transition-colors">
            {SITE_CONFIG.name}
          </Link>
          ...
          <div className="flex items-center gap-4">
            <button onClick={toggleCart} className="relative text-white/80 hover:text-white transition-colors" aria-label="Open cart">
