      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <h3 className="text-white text-lg font-medium tracking-wider mb-4">{SITE_CONFIG.name}</h3>
            <p className="text-sm leading-relaxed max-w-md">
              {SITE_CONFIG.description}. Grown with care in the pristine valleys of Himachal Pradesh.
            </p>
          </div>
          <div>
            <h4 className="text-white text-sm font-medium mb-4 uppercase tracking-wider">Quick Links</h4>
          ...
          <div>
            <h4 className="text-white text-sm font-medium mb-4 uppercase tracking-wider">Contact</h4>
